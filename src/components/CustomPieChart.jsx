...
const CustomPieChart = ({ data, height, outerRadius, innerRadius, color, findData, total, costType = 'Dollar' }) => {
        ...
        return (
            <>
                ...
                <text x={cx} y={cy} textAnchor="middle" fontSize={13} fontWeight={900}>
                    {costType === 'INR' ? '₹' : '$'}{total ? total.toLocaleString('en-IN') : totalNum.toLocaleString('en-IN')}
                </text>
            </>
        );
    };
